...
\centering
\begin{tikzpicture}
    \draw (-3,0) -- (-3,-11) (-1,-1) -- (-1,-4) (1,-3) -- (1,-6) (3,0) -- (3,-11);
    \node at (-3,.3) {Main};
   % \node at (-3,-3) {Sleeping};
    \node at (-1,.3) {Worker1};
    \node at (1,.3) {Worker2};
  ...
  %  \draw[->] (-3,-2) -- node[midway,above] {create()} (1,-2);
   ...
   % \draw[->] (1,-4) -- node[midway,above] {GetImage()} (3,-4);
    \draw[<-] (-1,-1) -- node[midway,above] {Image} (3,-1);
   % \node at (-1,-6) {Processing};
    \draw (-1,-5) -- (-1,-8) (-1,-9) -- (-1,-11) (1,-7) -- (1,-10);
    \draw[<-] (1,-3) -- node[midway,above] {Image} (3,-3);
    \draw[<-] (-3,-4) -- node[midway,above] {Angle} (-1,-4);
    \draw[<-] (-3,-6) -- node[midway,above] {Angle} (1,-6);
    %\draw[->] (-1,-8.2) -- node[midway,above] {GetImage()} (3,-8.2);
    \draw[<-] (-1,-5) -- node[midway,above] {Image} (3,-5);
    \draw[<-] (1,-7) -- node[midway,above] {Image} (3,-7);
    \draw[<-] (-3,-8) -- node[midway,above] {Angle} (-1,-8);
    \draw[<-] (-1,-9) -- node[midway,above] {Image} (3,-9);
    \draw[<-] (-3,-10) -- node[midway,above] {Angle} (1,-10);
